...
/**
 * This file was automatically generated by EvoMaster on 2024-06-02T04:59:51.478+02:00[Europe/Paris]
 * <br>
    ...
    */
    ...
    public void test_1() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .get(baseUrlOfSut + "/api/sessions/_EM_54_XYZ_/EVOMASTER?EMextraParam123=_EM_55_XYZ_")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
                .body("'status'", numberMatches(400.0))
                .body("'error'", containsString("Bad Request"))
                .body("'path'", containsString("/api/sessions/_EM_54_XYZ_/EVOMASTER"));
    ...
    public void test_2() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .get(baseUrlOfSut + "/api/sessions/_EM_174_XYZ_/EVOMASTER/66368e036f17eb581e883ca7?EMextraParam123=42")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
                .body("'status'", numberMatches(400.0))
                .body("'error'", containsString("Bad Request"))
                .body("'path'", containsString("/api/sessions/_EM_174_XYZ_/EVOMASTER/66368e036f17eb581e883ca7"));
    ...
    public void test_4() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .contentType("application/json")
                .body(" \"_EM_2555_XYZ_\" ")
                .put(baseUrlOfSut + "/api/sessions/_EM_2553_XYZ_/EVOMASTER/_EM_2554_XYZ_")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
                .body("'status'", numberMatches(400.0))
                .body("'error'", containsString("Bad Request"))
                .body("'path'", containsString("/api/sessions/_EM_2553_XYZ_/EVOMASTER/_EM_2554_XYZ_"));
    ...
    public void test_5() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                .header("x-EMextraHeader123", "")
                .delete(baseUrlOfSut + "/api/sessions/_EM_198_XYZ_/EVOMASTER/mxiYX3B6d4mQgN?EMextraParam123=42")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
                .body("'status'", numberMatches(400.0))
                .body("'error'", containsString("Bad Request"))
                .body("'path'", containsString("/api/sessions/_EM_198_XYZ_/EVOMASTER/mxiYX3B6d4mQgN"));
